    ...
    public function run(): void
    {
        $banners = [
            [
                ...
                'image_url' => 'images/banners/image/hero2.png',
                'secondary_image_url' => 'images/banners/image/banner_c.png',
                'third_image_url' => 'images/banners/image/hero2.png',
                'is_active' => true,
                'is_default' => true,
                'order' => 1,
            ...
            [
                ...
                'image_url' => 'images/banners/image/hero3.png',
                'secondary_image_url' => 'images/banners/image/hero_cover.svg',
                'third_image_url' => 'images/banners/image/hero3.png',
                'is_active' => true,
                'order' => 2,
            ...
            [
                ...
                'image_url' => 'images/banners/image/hero1.png',
                'secondary_image_url' => 'images/banners/image/Top Image Container.png',
                'third_image_url' => 'images/banners/image/hero1.png',
                'is_active' => true,
                'order' => 3,
            ...
            [
                ...
                'image_url' => 'images/banners/image/catBanner.png',
                'secondary_image_url' => 'images/banners/image/Pawmic1 1.png',
                'third_image_url' => 'images/banners/image/catBanner.png',
                'is_active' => true,
                'order' => 4,
