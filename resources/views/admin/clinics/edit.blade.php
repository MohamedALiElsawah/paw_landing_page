                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name_en') is-invalid @enderror" id="name_en"
                                name="name_en" value="{{ old('name_en', $clinic->getRawOriginal('name')['en'] ?? '') }}"
                                required>
                            @error('name_en')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('location_en') is-invalid @enderror"
                                ...
                                value="{{ old('location_en', $clinic->getRawOriginal('location')['en'] ?? '') }}" required>
                            @error('location_en')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('working_hours_en') is-invalid @enderror"
                                ...
                                value="{{ old('working_hours_en', $clinic->getRawOriginal('working_hours')['en'] ?? '') }}"
                                required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name_ar') is-invalid @enderror" id="name_ar"
                                name="name_ar" value="{{ old('name_ar', $clinic->getRawOriginal('name')['ar'] ?? '') }}"
                                required>
                            @error('name_ar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('location_ar') is-invalid @enderror"
                                ...
                                value="{{ old('location_ar', $clinic->getRawOriginal('location')['ar'] ?? '') }}" required>
                            @error('location_ar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('working_hours_ar') is-invalid @enderror"
                                ...
                                value="{{ old('working_hours_ar', $clinic->getRawOriginal('working_hours')['ar'] ?? '') }}"
                                required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                name="phone" value="{{ old('phone', $clinic->phone) }}" required>
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.1"
                                ...
                                value="{{ old('distance', $clinic->distance) }}">
                            @error('distance')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
