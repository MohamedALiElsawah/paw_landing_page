                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name_en') is-invalid @enderror" id="name_en"
                                name="name_en" value="{{ old('name_en', $clinic->getTranslation('name', 'en')) }}" required>
                            @error('name_en')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('location_en') is-invalid @enderror"
                                ...
                                value="{{ old('location_en', $clinic->getTranslation('location', 'en')) }}" required>
                            @error('location_en')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('working_hours_en') is-invalid @enderror"
                                ...
                                value="{{ old('working_hours_en', $clinic->getTranslation('working_hours', 'en')) }}"
                                required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name_ar') is-invalid @enderror" id="name_ar"
                                name="name_ar" value="{{ old('name_ar', $clinic->getTranslation('name', 'ar')) }}"
                                required>
                            @error('name_ar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.000001"
                                ...
                                value="{{ old('latitude', $clinic->latitude) }}" placeholder="e.g., 29.3340">
                            @error('latitude')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.000001"
                                ...
                                name="longitude" value="{{ old('longitude', $clinic->longitude) }}"
                                placeholder="e.g., 48.0760">
                            @error('longitude')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
