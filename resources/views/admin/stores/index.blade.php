        ...
        <div class="card-header bg-white border-bottom-0 py-3">
            ...
            <div class="card-toolbar">
                <div class="alert alert-info mb-0 py-2 px-3">
                    ...
                    Drag and drop rows to reorder stores. The order will be reflected on the home page.
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped datatable" style="width:100%" id="stores-table">
    ...
    <script>
        $(document).ready(function() {
            ...
            function saveNewOrder() {
                ...
                $.ajax({
                    url: '{{ route('admin.stores.reorder') }}',
                    type: 'POST',
                    data: {
                        order: order,
                        _token: '{{ csrf_token() }}'
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            showToast('Success', 'Stores order updated successfully.', 'success');
                        }
                    },
                    error: function(xhr) {
